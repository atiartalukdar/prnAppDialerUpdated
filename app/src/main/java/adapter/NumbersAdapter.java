...
public class NumbersAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        _item_call.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                _number.performClick();
            }
        });
        ...
        _item_sms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        try {
            if (numberModel.getSmsStatus()==null){
                _item_sms.setBackgroundColor(Color.TRANSPARENT);
            }else if (numberModel.getSmsStatus().equals(BP.SMS_DELIVERED)){
                _item_sms.setBackgroundColor(Color.GREEN);
            }else {
                _item_sms.setBackgroundColor(Color.TRANSPARENT);
            }
        }catch (NullPointerException e){
            _item_sms.setBackgroundColor(Color.TRANSPARENT);
            Log.e(TAG, "Sms status not found");
        }catch (Exception e){
            _item_sms.setBackgroundColor(Color.TRANSPARENT);
            Log.e(TAG, "Sms status not found" + e.getMessage());
        }
